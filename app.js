...
doc.setFontSize(9);
doc.setFont("helvetica", "bold");
doc.text("COTIZACIÓN N°", 135, 15);
doc.setFont("helvetica", "normal");
doc.text(q.id, 170, 15);

doc.setFont("helvetica", "bold");
doc.text("FECHA", 135, 20);
doc.setFont("helvetica", "normal");
doc.text(q.date, 163, 20);

// Quitamos "PRESUPUESTO"
doc.setFont("helvetica", "bold");
// doc.text("PRESUPUESTO", 145, 25);
doc.text("VÁLIDO HASTA", 135, 25);
doc.setFont("helvetica", "normal");
doc.text(q.validDate || q.date, 167, 25);
